...
import cn.lastwhisper.sorm.bean.JavaFieldGetSet;
import cn.lastwhisper.sorm.bean.TableInfo;
import cn.lastwhisper.sorm.core.DBManager;
import cn.lastwhisper.sorm.core.MySqlTypeConvertor;
import cn.lastwhisper.sorm.core.TableContext;
import cn.lastwhisper.sorm.core.TypeConvertor;
...
//		src.append("import java.util.*;\n\n");
	...
	public static void createJavaPOFile(TableInfo tableInfo, TypeConvertor convertor) {
		...
		String srcPath = PathUtils.GetSrcPath();//DBManager.getConf().getSrcPath() + "\\";
		String packagePath = PathUtils.GetPoPackagePath();//DBManager.getConf().getPoPackage().replaceAll("\\.", "/");
